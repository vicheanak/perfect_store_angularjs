...
var lng = 0;
for (var i = 0; i < 100; i ++){
 lat = Math.floor(Math.random()*900000) + 100000;
 lng = Math.floor(Math.random()*900000) + 100000;

 taxiData.push(new google.maps.LatLng(parseFloat('11.557' + lat), parseFloat('104.908' + lng)));
}
